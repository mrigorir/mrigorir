...
I'm a computer engineer who is passionate about layout and page design, also offering code solutions as needed. I'm Currently stdying at microverse :books: a remote software development school that allows devs from all over the world to pair-program and build projects together, using HTML, CSS, JavaScript, Ruby on Rails, React, Github and markdown among other technologies, in order to get a good job and improve my code skills while taking advantage of using :star:github. 
